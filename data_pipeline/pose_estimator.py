    ...
    def estimate_pose(self, frame, player_bboxes):
        ...
        if self.model is not None:
            ...
            for p in player_bboxes:
                ...
                syn_kpts[0] = [x1 + w*0.5, y1 + h*0.1]
                syn_kpts[5] = [x1 + w*0.3, y1 + h*0.25]
                syn_kpts[6] = [x1 + w*0.7, y1 + h*0.25]
                syn_kpts[7] = [x1 + w*0.2, y1 + h*0.4]
                syn_kpts[8] = [x1 + w*0.8, y1 + h*0.35]
                syn_kpts[9] = [x1 + w*0.1, y1 + h*0.5]
                syn_kpts[10] = [x1 + w*0.85, y1 + h*0.2]
                syn_kpts[11] = [x1 + w*0.35, y1 + h*0.55]
                syn_kpts[12] = [x1 + w*0.65, y1 + h*0.55]
                syn_kpts[13] = [x1 + w*0.35, y1 + h*0.75]
                syn_kpts[14] = [x1 + w*0.65, y1 + h*0.75]
                syn_kpts[15] = [x1 + w*0.35, y1 + h*0.95]
                syn_kpts[16] = [x1 + w*0.65, y1 + h*0.95]
